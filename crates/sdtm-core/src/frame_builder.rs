...
use sdtm_normalization::frame_builder::build_domain_frame_with_mapping;
use sdtm_normalization::wide::{build_ie_wide_frame, build_lb_wide_frame, build_vs_wide_frame};

// Public re-exports for external consumers
pub use sdtm_normalization::frame_builder::build_domain_frame;
