...
use std::path::Path;
use tss_ingest::{discover_domain_files, list_csv_files, load_study_metadata, read_csv_table};
use tss_map::{ColumnHint, MappingState as CoreMappingState};
use tss_standards::load_sdtm_ig;
...
impl StudyLoader {
    ...
    pub fn load_study(study_folder: &Path, header_rows: usize) -> Result<StudyState> {
        ...
        let domain_map: HashMap<String, (Option<String>, tss_model::Domain)> = sdtm_domains
            .into_iter()
...
///
/// Variables like STUDYID, DOMAIN, and --SEQ are auto-generated by the transform
/// system and should be marked as such.
///
/// USUBJID is NOT auto-generated by default - it requires a SUBJID mapping first.
/// When the user maps a source column to SUBJID, `sync_usubjid_from_subjid()` in
/// mapping.rs will automatically mark USUBJID as auto-generated.
fn auto_accept_generated_variables(mapping: &mut CoreMappingState) {
    ...
    // Auto-generated variables (NOT including USUBJID - that requires SUBJID mapping)
