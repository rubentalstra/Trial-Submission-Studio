//! Settings types and configuration for Trial Submission Studio.
//!
...
impl From<CtVersionSetting> for tss_standards::ct::CtVersion {
...
pub struct DeveloperSettings {
    ...
    pub bypassed_categories: HashSet<tss_validate::rules::Category>,
