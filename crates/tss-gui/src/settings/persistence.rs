...
//! - macOS: ~/Library/Application Support/com.trial-submission-studio.Trial Submission Studio/
//! - Windows: %APPDATA%/trial-submission-studio/config/
...
const APP_ORG: &str = "trial-submission-studio";
const APP_NAME: &str = "Trial Submission Studio";
