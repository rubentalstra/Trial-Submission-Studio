...
use super::types::{NormalizationPipeline, NormalizationRule, NormalizationType};
...
pub fn infer_normalization_rules(domain: &SdtmDomain) -> NormalizationPipeline {
...
fn infer_normalization_type(variable: &SdtmVariable, domain_code: &str) -> NormalizationType {
...
mod tests {
    ...
    fn make_variable(name: &str) -> SdtmVariable {
        SdtmVariable {
            name: name.to_string(),
            label: None,
