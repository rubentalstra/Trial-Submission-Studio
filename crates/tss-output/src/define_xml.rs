...
use tss_model::ct::{Codelist, TerminologyCatalog, TerminologyRegistry};
...
pub fn write_define_xml(
    ...
    root.push_attribute(("Originator", "Trial-Submission-Studio"));
    root.push_attribute(("SourceSystem", "Trial-Submission-Studio"));
