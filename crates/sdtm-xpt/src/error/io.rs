//! I/O error types for XPT file operations.
...
///
/// These errors occur during file reading/writing operations and represent
/// issues with the XPT file format or underlying I/O.
#[derive(Debug, Error)]
pub enum XptIoError {
    ...
    // === Validation errors (temporary, will be moved to ValidationError) ===
