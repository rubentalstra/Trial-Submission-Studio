...
impl CdiscVariable for SendVariable {
    fn name(&self) -> &str {
        &self.name
    }
...
///
/// ```
/// use tss_standards::send::{SendDomain, SendDatasetClass};
///
...
impl CdiscDomain for SendDomain {
    type Variable = SendVariable;
    ...
    fn variables(&self) -> &[SendVariable] {
        &self.variables
    }
}
