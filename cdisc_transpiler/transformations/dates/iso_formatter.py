...
from ...xpt_module.transformers.iso8601 import normalize_iso8601, normalize_iso8601_duration
    ...
    def transform(
        ...
        for col in transformed_df.columns:
            if "DUR" in col:
                ...
                transformed_df[col] = transformed_df[col].apply(normalize_iso8601_duration)
