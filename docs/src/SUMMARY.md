...
- [Interface Overview](user-guide/ui-overview.md)
- [Importing Data](user-guide/importing-data.md)
- [Column Mapping](user-guide/column-mapping.md)
...
- [Standards Overview](cdisc-standards/overview.md)
- [SDTM](cdisc-standards/sdtm/introduction.md)
    - [Domains](cdisc-standards/sdtm/domains.md)
    - [Variables](cdisc-standards/sdtm/variables.md)
    - [Validation Rules](cdisc-standards/sdtm/validation-rules.md)
- [Controlled Terminology](cdisc-standards/controlled-terminology.md)
- [ADaM (Preview)](cdisc-standards/adam-preview.md)
- [SEND (Preview)](cdisc-standards/send-preview.md)

---

# Output Formats

- [XPT (SAS Transport)](output-formats/xpt-format.md)
- [Dataset-XML](output-formats/dataset-xml.md)
- [Define-XML 2.1](output-formats/define-xml.md)
