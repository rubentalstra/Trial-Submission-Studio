...
Unlike terminal-based interfaces, a desktop GUI enables **persistent navigation**, **multi-panel layouts**, and **contextual actions**. The CDISC Transpiler GUI follows modern desktop application patterns similar to VS Code, database tools, and data management applications.

### Master Layout: Sidebar + Main Content

The application uses a **persistent sidebar** for navigation and context, with a large main content area that adapts based on the current task.
...
│   ║  • Study      ║│   ║                                               ║            │
│   ║  • Domains    ║│   ║   - Welcome / Home                            ║            │
│   ║  • Progress   ║│   ║   - Domain Mapping View                       ║            │
...
│                    │                                                                │
├────────────────────┴────────────────────────────────────────────────────────────────┤
│  Status: Ready  │  Study: DEMO_CF1234  │  Progress: 5/8 domains  │  ⚠ 2 warnings   │
└─────────────────────────────────────────────────────────────────────────────────────┘
```

### Sidebar Design

The sidebar provides **persistent context** and **navigation** throughout the application:

```
┌──────────────────────┐
│  📊 Study Overview   │  ◀── Section header
├──────────────────────┤
│                      │
│  📁 DEMO_CF1234      │  ◀── Current study
│     /path/to/study   │
│                      │
│  ── Progress ──────  │
│  ████████░░░░ 62%    │  ◀── Visual progress bar
│  5/8 domains done    │
│                      │
├──────────────────────┤
...
├──────────────────────┤
│                      │
│  ✅ DM Demographics  │  ◀── Completed (green)
│  ✅ AE Adverse Evts  │
│  🔶 CM Concom Meds   │  ◀── Current (highlighted)
│  ⏳ LB Laboratory    │  ◀── Pending (gray)
│  ⏳ VS Vital Signs   │
│  ⏳ EX Exposure      │
│  ⏳ MH Medical Hist  │
│  ⏳ DS Disposition   │
...
|-------------|----------|
| Click domain | Opens domain mapping view in main content |
| Hover domain | Shows tooltip with variable counts |
| Right-click domain | Context menu (mark complete, reset, etc.) |
| Click Quick Action | Executes action immediately |
| Collapse section | Click header to toggle visibility |

### Main Content Area Patterns

The main content area uses different layouts depending on the task:

#### Pattern 1: Single-Focus View (Welcome, Summary)

Full-width content for focused tasks:
...
#### Pattern 2: List + Detail View (Domain Mapping)

Master-detail pattern for reviewing mappings:

```
┌───────────────────────────────┬────────────────────────────────────────┐
│                               │                                        │
│   ╔═ SDTM Variable List ═══╗  │  ╔═══════ Variable Detail ═════════╗   │
│   ║                        ║  │  ║                                 ║   │
│   ║  Scrollable list of    ║  │  ║  Full details of selected       ║   │
│   ║  all SDTM variables    ║  │  ║  variable including:            ║   │
│   ║  for this domain       ║  │  ║                                 ║   │
│   ║                        ║  │  ║  • Variable metadata            ║   │
│   ║  Click to select       ║  │  ║  • Mapped source column         ║   │
│   ║                        ║  │  ║  • CT validation status         ║   │
│   ║  ▶ STUDYID   [AUTO]    ║  │  ║  • Sample data preview          ║   │
│   ║  ▶ DOMAIN    [AUTO]    ║  │  ║  • Action buttons               ║   │
│   ║  ▶ USUBJID   SUBJID    ║  │  ║                                 ║   │
│   ║  ▶ CMSEQ     [AUTO]    ║──┼──▶                                 ║   │
│   ║  ▶ CMTRT     CMTRT ✅  ║  │  ║                                 ║   │
│   ║                        ║  │  ║                                 ║   │
...
#### Pattern 3: Three-Panel View (Advanced Mapping)

For complex decisions requiring full context:

```
┌────────────────────┬─────────────────────────┬─────────────────────────┐
│                    │                         │                         │
│  ╔═ SDTM Vars ═══╗ │  ╔═ Source Columns ══╗  │  ╔═ Detail Panel ════╗  │
│  ║               ║ │  ║                   ║  │  ║                   ║  │
│  ║  Variables    ║ │  ║  Source columns   ║  │  ║  Full details of  ║  │
│  ║  grouped by   ║ │  ║  ranked by        ║  │  ║  current mapping  ║  │
│  ║  Core:        ║ │  ║  confidence:      ║  │  ║                   ║  │
│  ║               ║ │  ║                   ║  │  ║  CT validation    ║  │
│  ║  Required     ║ │  ║  🟢 98% CMTRT     ║  │  ║  Sample data      ║  │
│  ║  Expected     ║ │  ║  🟢 89% MED_NAME  ║  │  ║  Actions          ║  │
│  ║  Permissible  ║ │  ║  🟡 71% DRUG      ║  │  ║                   ║  │
│  ║               ║ │  ║                   ║  │  ║                   ║  │
│  ╚═══════════════╝ │  ╚═══════════════════╝  │  ╚═══════════════════╝  │
│                    │                         │                         │
...
| Window Size | Sidebar | Main Content |
|-------------|---------|--------------|
| **Wide** (≥1400px) | Full sidebar (250px) | Three-panel layout available |
| **Medium** (1000-1400px) | Full sidebar | Two-panel layout |
| **Narrow** (<1000px) | Collapsible icon bar | Single panel with tabs |
...
| Sidebar BG | #F5F5F5 | #252526 | Sidebar background |
...
The GUI uses a **persistent sidebar** design. All screens (except the initial welcome) show the sidebar for navigation and context.

### Screen 1: Welcome Screen (No Sidebar)

The welcome screen is a focused, centered layout for study selection:
...
│                      with guided, interactive mapping.                              │
│                                                                                     │
│                                                                                     │
│        ┌────────────────────────────────────────────────────────────────┐           │
│        │  📂 Recent Studies                                             │           │
...
│                                                                                     │
│        ┌────────────────────────────────────────────────────────────────┐           │
│        │  ℹ️  Standards: SDTMIG v3.4  •  CT 2024-03-29  •  52 domains   │           │
│        └────────────────────────────────────────────────────────────────┘           │
│                                                                                     │
│                                                                                     │
├─────────────────────────────────────────────────────────────────────────────────────┤
│  Ready                                                        Theme: Light ◉ Dark ○ │
└─────────────────────────────────────────────────────────────────────────────────────┘
```

### Screen 2: Main Workspace (Sidebar + Content)

Once a study is loaded, the sidebar appears and remains visible throughout:
...
├──────────────────────────┬──────────────────────────────────────────────────────────────────────┤
│                          │                                                                      │
│  📊 Study Overview       │   ┌─ Study Dashboard ─────────────────────────────────────────────┐  │
│  ──────────────────────  │   │                                                               │  │
│                          │   │   📁 DEMO_CF1234_NL_20250120                                  │  │
│  📁 DEMO_CF1234          │   │   Path: /data/studies/DEMO_CF1234_NL_20250120                 │  │
│     /data/studies/...    │   │                                                               │  │
│                          │   │   ┌─────────────────────────────────────────────────────────┐ │  │
│  ── Progress ──────────  │   │   │                                                         │ │  │
│  ████████░░░░░░░░  50%   │   │   │              Mapping Progress                           │ │  │
...
│                          │   │   │   ████████████████░░░░░░░░░░░░░░░░░  50%                │ │  │
│  📋 Domains              │   │   │                                                         │ │  │
│  ──────────────────────  │   │   │   Completed: 4/8 domains                                │ │  │
│                          │   │   │   Variables Mapped: 89/158                              │ │  │
│  ✅ DM  Demographics     │   │   │   Pending Review: 12                                    │ │  │
│  ✅ AE  Adverse Events   │   │   │   SUPP Candidates: 7                                    │ │  │
│  ✅ CM  Concom Meds      │   │   │                                                         │ │  │
│  ✅ LB  Laboratory       │   │   └─────────────────────────────────────────────────────────┘ │  │
│  ⏳ VS  Vital Signs      │   │                                                               │  │
│  ⏳ EX  Exposure         │   │   ┌─ Domain Overview ─────────────────────────────────────┐   │  │
│  ⏳ MH  Medical History  │   │   │                                                       │   │  │
│  ⏳ DS  Disposition      │   │   │  Domain  │ Source Files  │ Req │ Exp │ Status        │   │  │
│                          │   │   │  ────────┼───────────────┼─────┼─────┼───────────    │   │  │
│  ⚡ Quick Actions        │   │   │  DM      │ dm.csv        │ 8/8 │ 5/5 │ ✅ Complete   │   │  │
│  ──────────────────────  │   │   │  AE      │ ae.csv        │ 6/6 │ 10/15│ ✅ Complete   │   │  │
│                          │   │   │  CM      │ cm.csv        │ 5/5 │ 6/8 │ ✅ Complete   │   │  │
│  [📂 Change Study]       │   │   │  LB      │ lb_*.csv (3)  │10/10│ 8/12│ ✅ Complete   │   │  │
│  [💾 Save Progress]      │   │   │  VS      │ vs.csv        │ 0/5 │ 0/6 │ ⏳ Pending    │   │  │
│  [📤 Generate SDTM]      │   │   │  EX      │ ex.csv        │ 0/7 │ 0/8 │ ⏳ Pending    │   │  │
│  [📊 View Report]        │   │   │  MH      │ mh.csv        │ 0/4 │ 0/8 │ ⏳ Pending    │   │  │
│                          │   │   │  DS      │ ds.csv        │ 0/4 │ 0/4 │ ⏳ Pending    │   │  │
│  📈 Statistics           │   │   │                                                       │   │  │
│  ──────────────────────  │   │   └───────────────────────────────────────────────────────┘   │  │
│  Mapped:      89         │   │                                                               │  │
│  Pending:     69         │   │   Click a domain in the sidebar to start mapping              │  │
│  SUPP:         7         │   │                                                               │  │
│  Skipped:      0         │   └───────────────────────────────────────────────────────────────┘  │
│                          │                                                                      │
├──────────────────────────┴──────────────────────────────────────────────────────────────────────┤
│  Study loaded  │  4/8 domains complete  │  12 variables need review  │  Ready to map           │
└─────────────────────────────────────────────────────────────────────────────────────────────────┘
```

### Screen 3: Domain Mapping View (The Core Screen)

When clicking a domain in the sidebar, the main content shows the mapping interface:

```
┌─────────────────────────────────────────────────────────────────────────────────────────────────┐
│  🏥 CDISC Transpiler - VS (Vital Signs)                                     [─] [□] [×]         │
├─────────────────────────────────────────────────────────────────────────────────────────────────┤
│  File   Edit   View   Tools   Help                                                              │
├──────────────────────────┬──────────────────────────────────────────────────────────────────────┤
│                          │                                                                      │
│  📊 Study Overview       │   VS - Vital Signs                                                   │
│  ──────────────────────  │   ════════════════════════════════════════════════════════════════   │
│                          │   Class: Findings  │  Structure: One record per vital sign per visit │
│  📁 DEMO_CF1234          │   Source: vs.csv (856 rows, 15 columns)                              │
│                          │                                                                      │
│  ── Progress ──────────  │   Progress: ███████████░░░░░░░░░░░░░░░ 8/15 mapped                   │
│  ████████░░░░░░░░  50%   │                                                                      │
│  4 of 8 domains          │  ┌─ SDTM Variables ─────────────────┬─ Variable Detail ─────────────┐│
│                          │  │                                  │                               ││
│  📋 Domains              │  │  🔍 Filter: [_______________]    │  VSTESTCD                     ││
│  ──────────────────────  │  │                                  │  ─────────────────────────────││
│                          │  │  ── Required (5) ──────────────  │                               ││
│  ✅ DM  Demographics     │  │  🔄 STUDYID      [AUTO]          │  Label: Vital Signs Test      ││
│  ✅ AE  Adverse Events   │  │  🔄 DOMAIN       [AUTO]          │         Short Name            ││
│  ✅ CM  Concom Meds      │  │  ✅ USUBJID      ← SUBJID        │  Type:  Char (8)              ││
│  ✅ LB  Laboratory       │  │  🔄 VSSEQ        [AUTO]          │  Core:  Required              ││
│  🔶 VS  Vital Signs ◀    │  │  ⚠️ VSTESTCD     [NEED] ◀        │  Role:  Topic                 ││
│  ⏳ EX  Exposure         │  │                                  │                               ││
│  ⏳ MH  Medical History  │  │  ── Expected (6) ──────────────  │  📚 CT: C66741 (VSTESTCD)     ││
│  ⏳ DS  Disposition      │  │  ⚠️ VSTEST       [NEED]          │     Extensible: No            ││
│                          │  │  ✅ VSORRES      ← RESULT        │     Terms: SYSBP, DIABP,      ││
│  ⚡ Quick Actions        │  │  ✅ VSORRESU     ← UNIT          │     PULSE, TEMP, RESP...      ││
│  ──────────────────────  │  │  ⚪ VSSTRESC     --              │                               ││
│                          │  │  ⚪ VSSTRESN     --              │  📖 Description:              ││
│  [📂 Change Study]       │  │  ✅ VSDTC        ← VISIT_DATE    │     Short name of the test    ││
│  [💾 Save Progress]      │  │                                  │     described in VSTEST.      ││
│  [📤 Generate SDTM]      │  │  ── Permissible (4) ───────────  │                               ││
│  [📊 View Report]        │  │  ⚪ VSCAT        --              │  ─────────────────────────────││
│                          │  │  ⚪ VSSCAT       --              │                               ││
│  📈 Statistics           │  │  ⚪ VSPOS        --              │  📊 Suggested Source:         ││
│  ──────────────────────  │  │  ⚪ VSLOC        --              │  ┌─────────────────────────┐  ││
│  Mapped:      89         │  │                                  │  │ 🟢 96%  VITAL_TEST      │  ││
│  Pending:     69         │  │                                  │  │ 🟡 78%  TEST_CODE       │  ││
│  SUPP:         7         │  │  Legend:                         │  │ 🔴 45%  PARAM           │  ││
│  Skipped:      0         │  │  🔄 Auto  ✅ Mapped  ⚠️ Need     │  └─────────────────────────┘  ││
│                          │  │  ⚪ Optional (unmapped)          │                               ││
│                          │  │                                  │  [✓ Accept VITAL_TEST]        ││
│                          │  │                                  │  [🔄 Select Different...]     ││
│                          │  └──────────────────────────────────┴───────────────────────────────┘│
│                          │                                                                      │
├──────────────────────────┴──────────────────────────────────────────────────────────────────────┤
│  VS Domain  │  Required: 4/5  Expected: 2/6  │  ⚠️ 2 variables need mapping  │  [Mark Complete]│
└─────────────────────────────────────────────────────────────────────────────────────────────────┘
```

### Screen 3a: Source Selection Dialog (Modal)

When clicking "Select Different..." a modal dialog appears:
...
### Screen 3b: CT Mismatch Warning Dialog
...
### Screen 4: Unmapped Source Columns (Sidebar Context)

When all SDTM variables are mapped, show unmapped source columns:

```
┌─────────────────────────────────────────────────────────────────────────────────────────────────┐
│  🏥 CDISC Transpiler - CM Unmapped Columns                                  [─] [□] [×]         │
├─────────────────────────────────────────────────────────────────────────────────────────────────┤
│  File   Edit   View   Tools   Help                                                              │
├──────────────────────────┬──────────────────────────────────────────────────────────────────────┤
│                          │                                                                      │
│  📊 Study Overview       │   CM - Unmapped Source Columns                                       │
│  ──────────────────────  │   ════════════════════════════════════════════════════════════════   │
│                          │                                                                      │
│  📁 DEMO_CF1234          │   These source columns were not mapped to any SDTM variable.         │
│                          │   Choose what to do with each:                                       │
│  ── Progress ──────────  │                                                                      │
│  ████████░░░░░░░░  50%   │  ┌──────────────────────────────────────────────────────────────────┐│
│  4 of 8 domains          │  │                                                                  ││
│                          │  │   Source Column  │ Label               │ Action                  ││
│  📋 Domains              │  │  ────────────────┼─────────────────────┼──────────────────────   ││
│  ──────────────────────  │  │   COMMENTS       │ "Additional notes"  │ [📤 Send to SUPP   ▼]   ││
│                          │  │   BATCH_NUM      │ "Drug batch number" │ [📤 Send to SUPP   ▼]   ││
│  ✅ DM  Demographics     │  │   INTERNAL_ID    │ "Internal ID"       │ [⏭️ Skip - not needed▼]  ││
│  ✅ AE  Adverse Events   │  │   REVIEWER       │ "Data reviewer"     │ [⏭️ Skip - not needed▼]  ││
│  🔶 CM  Concom Meds ◀    │  │                                                                  ││
│  ✅ LB  Laboratory       │  └──────────────────────────────────────────────────────────────────┘│
│  ⏳ VS  Vital Signs      │                                                                      │
│  ⏳ EX  Exposure         │  ┌─ SUPP Configuration for COMMENTS ────────────────────────────────┐│
│  ⏳ MH  Medical History  │  │                                                                  ││
│  ⏳ DS  Disposition      │  │   RDOMAIN:  CM         IDVAR:  CMSEQ                             ││
│                          │  │   QNAM:     [CMCOMM____]  (max 8 chars, auto-generated)          ││
│  ⚡ Quick Actions        │  │   QLABEL:   [Comments about medication__________________]        ││
│  ──────────────────────  │  │   QORIG:    [ CRF                                      ▼]        ││
│                          │  │   QEVAL:    [______________________________________] (optional)  ││
│  [📂 Change Study]       │  │                                                                  ││
│  [💾 Save Progress]      │  │   Preview: SUPPCM will contain 1 additional variable             ││
│  [📤 Generate SDTM]      │  │                                                                  ││
│  [📊 View Report]        │  └──────────────────────────────────────────────────────────────────┘│
│                          │                                                                      │
│  📈 Statistics           │                                                                      │
│  ──────────────────────  │           ┌────────────────────────┐   ┌────────────────────┐        │
│  Mapped:      89         │           │   ✓ Apply & Continue   │   │   ◀ Back           │        │
│  Pending:     69         │           └────────────────────────┘   └────────────────────┘        │
│  SUPP:         7         │                                                                      │
│  Skipped:      0         │                                                                      │
│                          │                                                                      │
├──────────────────────────┴──────────────────────────────────────────────────────────────────────┤
│  CM Domain  │  All SDTM variables mapped ✅  │  4 source columns unmapped  │  Review required  │
└─────────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────────────────────────────────────┐
│  🏥 CDISC Transpiler - Generate Output                                      [─] [□] [×]         │
├─────────────────────────────────────────────────────────────────────────────────────────────────┤
│  File   Edit   View   Tools   Help                                                              │
├──────────────────────────┬──────────────────────────────────────────────────────────────────────┤
│                          │                                                                      │
│  📊 Study Overview       │   Generate SDTM Output                                               │
│  ──────────────────────  │   ════════════════════════════════════════════════════════════════   │
│                          │                                                                      │
│  📁 DEMO_CF1234          │  ┌─ Mapping Summary ─────────────────────────────────────────────────┐│
│                          │  │                                                                  ││
│  ── Progress ──────────  │  │   Domain │ Required │ Expected  │ SUPP  │ Status                 ││
│  ████████████████ 100%   │  │  ────────┼──────────┼───────────┼───────┼─────────────────────   ││
│  8 of 8 domains ✅       │  │   DM     │ 8/8  ✅  │ 5/5   ✅  │ 0     │ ✅ Ready               ││
│                          │  │   AE     │ 6/6  ✅  │ 12/15     │ 2     │ ✅ Ready               ││
│  📋 Domains              │  │   CM     │ 5/5  ✅  │ 6/8       │ 3     │ ✅ Ready               ││
│  ──────────────────────  │  │   LB     │ 10/10✅  │ 8/12      │ 1     │ ✅ Ready               ││
│                          │  │   VS     │ 5/5  ✅  │ 4/6       │ 0     │ ✅ Ready               ││
│  ✅ DM  Demographics     │  │   EX     │ 7/7  ✅  │ 5/8       │ 0     │ ✅ Ready               ││
│  ✅ AE  Adverse Events   │  │   MH     │ 4/4  ✅  │ 6/8       │ 1     │ ✅ Ready               ││
│  ✅ CM  Concom Meds      │  │   DS     │ 4/4  ✅  │ 3/4       │ 0     │ ✅ Ready               ││
│  ✅ LB  Laboratory       │  │                                                                  ││
│  ✅ VS  Vital Signs      │  └──────────────────────────────────────────────────────────────────┘│
│  ✅ EX  Exposure         │                                                                      │
│  ✅ MH  Medical History  │  ┌─ Output Options ──────────────────────────────────────────────────┐│
│  ✅ DS  Disposition      │  │                                                                  ││
│                          │  │   Output Formats:                    Output Location:            ││
│  ⚡ Quick Actions        │  │   ☑ XPT (SAS Transport v5)           📂 [./output/sdtm    ] [...] ││
│  ──────────────────────  │  │   ☑ Dataset-XML                                                  ││
│                          │  │   ☑ Define-XML v2.1                  Additional Options:         ││
│  [📂 Change Study]       │  │   ☐ SAS Program Files                ☑ Include SUPP datasets     ││
│  [💾 Save Progress]      │  │                                      ☑ Generate validation report││
│  [📤 Generate SDTM] ◀    │  │                                                                  ││
│  [📊 View Report]        │  └──────────────────────────────────────────────────────────────────┘│
│                          │                                                                      │
│  📈 Statistics           │  ┌─ Validation Summary ──────────────────────────────────────────────┐│
│  ──────────────────────  │  │                                                                  ││
│  Mapped:     158         │  │   ⚠️ 3 Warnings:                                                 ││
│  Pending:      0         │  │   • AE: AESEV has 2 values using sponsor extension               ││
│  SUPP:         7         │  │   • LB: LBORRESU missing for 12 records                          ││
│  Skipped:      3         │  │   • CM: CMENDTC is null for all records                          ││
│                          │  │                                                                  ││
│                          │  │   ❌ 0 Errors - Ready to generate                                ││
│                          │  │                                                                  ││
│                          │  └──────────────────────────────────────────────────────────────────┘│
│                          │                                                                      │
│                          │                  ┌──────────────────────────────────┐                │
...
### Screen 5a: Output Progress (Modal)
