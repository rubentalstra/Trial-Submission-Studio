...
class MockTransformer:
    ...
    def __init__(self, name: str, applies: bool = True, success: bool = True, multiply_rows: int = 1):
...
class TestTransformationPipeline:
    ...
    def test_method_chaining(self):
        ...
        pipeline.add_transformer(MockTransformer("T1")).add_transformer(MockTransformer("T2"))
