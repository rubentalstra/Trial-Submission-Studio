...
from cdisc_transpiler.infrastructure.io.exceptions import DataParseError, DataSourceNotFoundError
...
class TestStudyDataRepositoryProtocol:
    ...
    def test_implements_protocol(self):
        ...
        from cdisc_transpiler.application.ports.repositories import StudyDataRepositoryPort
