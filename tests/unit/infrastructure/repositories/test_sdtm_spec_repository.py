...
class TestSDTMSpecRepository:
    ...
    def test_get_domain_variables_contains_expected_fields(self, repo_with_mock_data):
        ...
        usubjid = next((v for v in variables if v.get("Variable Name") == "USUBJID"), None)
    ...
    def test_with_real_spec_files(self):
        ...
        if domains:
            ...
            assert "STUDYID" in var_names or "studyid" in [n.lower() for n in var_names if n]
...
class TestSDTMSpecRepositoryProtocol:
    ...
    def test_implements_protocol(self):
        ...
        from cdisc_transpiler.application.ports.repositories import SDTMSpecRepositoryPort
